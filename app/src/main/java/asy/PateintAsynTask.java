...
public class PateintAsynTask extends AsyncTask<String, String, String> {
    ...
    String response = "";
    public PateintAsynTask(Context context, String url, ProgressDialog mProgressDialog, HashMap<String, String> hm) {
